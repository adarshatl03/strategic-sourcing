...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0005_cart_cartorder_cartorderitems'),
        ('vendor', '0001_initial'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_items', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.cartorderitems')),
