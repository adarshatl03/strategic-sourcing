...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0004_alter_gallery_options_alter_product_status'),
        ('vendor', '0001_initial'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart_id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefg1234', length=10, max_length=10, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, max_length=100, null=True)),
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefg1234', length=10, max_length=10, prefix='', unique=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
