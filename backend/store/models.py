...
class Product(models.Model):
    ...
    # Update the rating after saving (if related data depends on a saved instance)
        self.rating = self.product_rating() or 0

    # Save again to store the updated rating
...
class Notification(models.Model):
        ...
        order_items = models.ForeignKey(CartOrderItems,on_delete=models.SET_NULL,null=True,blank=True)
